...
:::
- **3x RGBW NeoPixel sticks** from Adafruit: [RGBW NeoPixel Stick from Adafruit](https://www.adafruit.com/product/2867). I'd recommend using [high density flexible strips instead](https://www.adafruit.com/product/2847).
